      ...
      <nav class="navbar navbar-expand-lg bg-warning bg-gradient row shadow-sm navigation-bar-final p-2 mx-auto">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse icons" id="navbarSupportedContent">
              ...
              <!-- Barra de búsqueda -->
              <form class="d-md-flex text-center ms-auto me-0 p-2" role="search" method="get" action="busqueda.php">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h3 class="dark-sh"><b>¡LA SECUELA DEL JUEGO MÁS ACLAMADO DE NINTENDO SWITCH!</b></h3>
            ...
            <a href="#" class="link-light link-offset-2 link-underline link-underline-opacity-0">
                ...
                <div class="card bg-danger rounded-4 h-auto w-100">
                    ...
                    <div class="card-body text-center text-light rounded-bottom p-2">
                      ...
                      <p class="card-text">
                        <b style="text-shadow: 0px 0px 3px rgba(0, 0, 0, 0.5);">
                          Los pioneros de la industria siguen demostrando por qué son el primer lugar.
                        </b>
                      </p>
