...
<html>
    ...
    <form class="bg-warning bg-gradient border border-light-subtle border-4 p-5 rounded-4 mx-auto mt-5" style="width: 400px;" action="#" method="post">

        <h2 class="text-center titulo_pro text-light"><b>CONFIGURACION</b></h2>
