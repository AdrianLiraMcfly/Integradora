      ...
      <nav class="navbar navbar-expand-lg bg-warning bg-gradient row shadow-sm navigation-bar-final p-2 mx-auto">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse icons" id="navbarSupportedContent">
              ...
              <!-- Barra de búsqueda
              <form class="d-flex text-center ms-auto my-auto p-2" role="search" method="get" action="busqueda.php">
      ...
      <?php
        if (isset($_GET['mensaje'])) 
        {
          ...
          <div class="container-fluid w-50 p-2">
            <div class="alert alert-success bg-success border border-3 border-light text-center text-light rounded-pill">

              <span><b class="text-uppercase fst-italic"><?php print $mensajeAlerta; ?></b></span>
              <br/>

              <span class="fw-normal" style="font-size:medium;">
                <a href="index.php" class="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                  Inicio
                </a>
              </span>
        ...
        if (isset($_GET['mensajerr'])) 
        {
          ...
          <div class="container-fluid w-50 p-2">
            <div class="alert border border-3 border-light text-center text-light rounded-pill" style="background-color: red;">
