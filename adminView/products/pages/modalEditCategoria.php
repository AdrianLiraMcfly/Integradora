...
<div class="modal fade" id="modalEditCategoria" tabindex="-1" aria-labelledby="editaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"> 
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="actualizarCategoria.php" method="post" enctype="multipart/form-data">
