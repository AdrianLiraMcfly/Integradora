...
<body class="bg-white" style="background-image: url(css/img/wallpaper.jpg)">
  ...
  <nav class="navbar navbar-expand-lg bg-warning bg-gradient row shadow-sm navigation-bar-final p-2 mx-auto">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse icons" id="navbarSupportedContent">
              ...
              <!-- Barra de búsqueda 
              <form class="d-flex text-center ms-auto" role="search" method="post" action="busqueda.php">
  ...
  <?php
           ...
           else if (isset($_GET['mensajegood'])) 
           {
            ...
            <div class="alert bg-success mx-auto mt-2 border border-3 border-light rounded-4 text-center" style="width: fit-content;">
